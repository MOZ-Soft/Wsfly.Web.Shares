        ...
        *************************************************/
        ...
        function InitDefaultValue() {
            ...
            if (defaultValue != undefined && defaultValue != null && defaultValue != "") {
                ...
                day.val(defaultValue);
            }
        }
        InitDefaultValue();
    },
    InitAreaOptions: function (countryId, provinceId, cityId, provinceChangeEvent, cityChangeEvent) {
        /*************************************************
        *
        *       国家、省份、城市联动插件
        *       Author: Wsfly.com
        ...
        function InitDefaultValue() {
            if (country) {
                ...
                if (countryDefaultValue != undefined && countryDefaultValue != null && countryDefaultValue != "") {
                    ...
                    //country.find("option[text='" + countryDefaultValue + "']").attr("selected", true);
            ...
            if (provincDefaultValue != undefined && provincDefaultValue != null && provincDefaultValue != "") {
                ...
                //province.find("option[text='" + provincDefaultValue + "']").attr("selected", true);
                province.children().each(function () {
                    if ($(this).text() == provincDefaultValue) {
                        var pid = $(this).val();
                        province.val(pid);
                        province.attr("defaultValue", "");
                        ...
                        if (cityId) {
                            InitCity(pid, function () {
                                ...
                                if (cityDefaultValue != undefined && cityDefaultValue != null && cityDefaultValue != "") {
                                    ...
                                    //city.find("option[text='" + cityDefaultValue + "']").attr("selected", true);
                                    city.children().each(function () {
                                        if ($(this).text() == cityDefaultValue) {
                                            city.val($(this).val());
                                            city.attr("defaultValue", "");
                                        }
                                    });
                                }
                            });
